      ...
      children: [
        ...
        new Paragraph({
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nContainerCode Club, London | July 2019 - Present", italics: true }),
            ],
          }),
          ...[
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nVault Platform | July 2022 - December 2023", italics: true }),
            ],
          }),
          ...[
        ...
        new Paragraph({
            children: [
              ...
              new TextRun({ text: "\neConsult Health | October 2021 - June 2022", italics: true }),
            ],
          }),
          ...[
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "\nSenior DevOps Engineer", bold: true }),
              new TextRun({ text: "\nDoctor Care Anywhere | March 2021 - December 2021", italics: true }),
            ],
          }),
          ...[
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nRank Group | March 2020 - March 2021", italics: true }),
            ],
          }),
          ...[
        ...
        new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nAdjoint Inc. | August 2019 - March 2020", italics: true }),
            ],
          }),
          ...[
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nOpenAsset | January 2018 - August 2019", italics: true }),
            ],
          }),
          ...[
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nIndivior PLC | March 2016 - January 2018", italics: true }),
            ],
          }),
          ...[
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({ text: "\nSC Johnson Ltd. | August 2015 - February 2016", italics: true }),
            ],
          }),
          ...[
        ...
        new Paragraph({
          ...
          new Paragraph({
            children: [new TextRun({ text: "Cloud & Infrastructure", bold: true })],
          }),
          new Paragraph({
          ...
          new Paragraph({
            children: [new TextRun("Jenkins, GitLab CI/CD, Azure DevOps, GitHub Actions, ArgoCD, Terraform, Ansible, CircleCI, Vagrant, Packer")],
          }),
          new Paragraph({
            children: [new TextRun({ text: "\nSecurity & Monitoring", bold: true })],
          }),
          new Paragraph({
            children: [new TextRun("IAM, Zero Trust, CloudWatch, Prometheus, Grafana, ELK Stack, Datadog, Splunk, Dynatrace")],
          }),
          new Paragraph({
            children: [new TextRun({ text: "\nProgramming & Scripting Languages", bold: true })],
          }),
          new Paragraph({
          ...
          new Paragraph({
            children: [new TextRun("MERN Stack (MongoDB, Express.js, React, Node.js)")],
          }),
          ...
          new Paragraph({
            children: [
              new TextRun("Diploma in Multimedia Technology - Dalewares Institute of Technology, Lagos, Nigeria"),
            ],
          }),
          new Paragraph({
            children: [
              new TextRun("Cybersecurity: Managing Risk in the Information Age - Harvard University (November 2017 - July 2018)"),
            ],
          }),
        // Generate and save document
        new Paragraph({
            children: [new TextRun({ text: "\nReference will be provided upon request.", bold: true })],
          }),
        ],
      }],
    });
