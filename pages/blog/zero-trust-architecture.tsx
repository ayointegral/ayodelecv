        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          <section id="introduction" className="mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              ...
              network, is automatically trusted...
            </p>
          </section>
          ...
          <section id="what-is-zero-trust" className="mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              ...
              principle of "never trust, always verify." It assumes that every
              access request, regardless of origin, must be authenticated and
              authorised...
            </p>
          </section>
          ...
          <section id="conclusion" className="mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              ...
              it's a strategic approach to ensuring the integrity and security
